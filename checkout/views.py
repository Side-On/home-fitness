...
def checkout(request):
    ...
    if request.method == 'POST':
            ...
            for item_id, item_data in bag.items():
                try:
                    ...
                    messages.error(request, (
                        "Unfortunately, one of the products in your isn't on our database. Very strange. Please contact us and let us know.")
                    )
                    order.delete()
        ...
        bag = request.session.get('bag', {})
        if not bag:
            messages.error(request, "There's nothing in your bag, get shopping!")
...
def checkout_success(request, order_number):
    ...
    if request.user == order.user_profile.user:
        ...
        messages.error(request, 'Sorry, you can only do that if you are the user who ordered the item')
